...
import torch # conda install pytorch torchvision cudatoolkit=10.2 -c pytorch
...
def get_all_prob(all_patches, minibatch_size, model, device, parameters):   
    ...
    #print(tools.partition_batch(all_patches, minibatch_size))
...
def get_image_path(short_file_path, parameters):
   ...
   #print(os.path.join(parameters['original_image_path'], short_file_path + image_extension))
    ...
    for exam in tqdm.tqdm(exam_list):
        ...
        if len(all_patches) != 0:
            ...
            for (short_file_path, image_shape, view, horizontal_flip, width_stride_list, length_stride_list) \
                ...
                #print('probabilities_to_heatmap 0')
...
def load_model(parameters):
    ...
    """
    print('torch has cudnn:', torch.has_cudnn)
...
def main():
    ...
    batch_size = 100
    seed = 3
    model_path = r'../../models/sample_patch_model.p'
    image_path = r'../../../Data/INbreast_Dataset/AllDICOMs_cropped/'
    output_heatmap_path = r'../../../Data/INbreast_Dataset/AllDICOMs_heatmaps/'
    use_hdf5 = False
    data_path = r'../../../Data/INbreast_Dataset/AllDICOMs_cropped/cropped_center_exam_list.pkl'
    ...
    parameters = dict(
        ...
        initial_parameters=model_path,
        input_channels=3,
        number_of_classes=4,
        
        data_file=data_path,
        original_image_path=image_path,
        save_heatmap_path=[os.path.join(output_heatmap_path, 'heatmap_malignant'),
                            os.path.join(output_heatmap_path, 'heatmap_benign')],
